...
const calculateCartTotals = (items: CartItem[]): Omit<Cart, 'id' | 'items' | 'currency' | 'updatedAt'> => {
  ...
  // If cart is empty, all totals should be 0
  if (totalItems === 0) {
    return {
      totalItems: 0,
      subtotal: 0,
...
export const useCartStore = create<CartStore>()(
  persist(
    ...
    {
      name: 'ekart-cart-storage',
      version: 1,
    }
  )
);

// React Context for additional cart utilities
interface CartContextType {
  // Any additional cart utilities can be added here
}
...
// Custom hooks for easier cart operations
